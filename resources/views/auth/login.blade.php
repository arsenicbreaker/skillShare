...
<main class="auth">
    ...
    <section class="card">
        ...
        <header class="card__head">
            ...
            <p class="sub">Senang bertemu lagi!</p>
        </header>
        ...
        <form class="form" method="POST" action="{{ route('login') }}" novalidate>
            ...
            <div class="field">
                <div class="input-wrap">
                    ...
                    <button type="button" class="reveal" aria-pressed="false" aria-label="Tampilkan kata sandi">
            ...
            <button type="submit" class="btn doorbtn">
                <span class="doorbtn__label">Masuk</span>
        ...
        <p class="foot">Belum punya akun? <a href="{{ route('register') }}" class="link">Daftar sekarang</a></p>
    </section>
</main>
...
function applyFoxState() {
    ...
    if (document.activeElement === pass) {
        fox.classList.add(showing ? 'is-peek' : 'is-cover');
        eyeMode = showing ? 'up' : 'cursor';
    } else if (document.activeElement === emailEl) {
        eyeMode = 'caret';
    } else {
        eyeMode = 'cursor';
    }
...
pass.addEventListener('focus', applyFoxState);
pass.addEventListener('blur',  applyFoxState);
...
reveal.addEventListener('click', () => {
    ...
    reveal.setAttribute('aria-label', show ? 'Sembunyikan kata sandi' : 'Tampilkan kata sandi');
    pass.focus();
    applyFoxState();
});
...
form.addEventListener('submit', async (e) => {
    ...
    status.textContent = 'Selamat datang!';
    fox.classList.remove('is-cover', 'is-peek');
